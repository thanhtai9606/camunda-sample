 ...
 *
 */
public class KPITransformListener extends AbstractCmmnTransformListener {

  public static final List<KPIElement> PARSED_KPI_ELEMENTS = new ArrayList<KPIElement>();
